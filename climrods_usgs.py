...
class NLDAS_Downloader():
    ...
    def watershed_from_gauge(self, usgs_info, gage_id_col):
        '''
        :param usgs_info: path to a CSV file of numeric site numbers for USGS streamgages
        '''

        gage_info = pd.read_csv(usgs_info)
        gages = gage_info[gage_id_col]
...
os.chdir('/Volumes/GoogleDrive/Shared drives/Lauren and Hilary/Regional Overland Flow Project/Data and Scripts/San Pedro River')
out_dir = "./NLDAS output"
...
usgs_info = pd.read_csv('./Q_site_info.csv')
gage_id_col = 'site_no'
